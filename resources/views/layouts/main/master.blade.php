...
<html lang="vi" prefix="og: https://ogp.me/ns#" class="loading-site no-js">
   ...
   <head>
      ...
      <script  data-wpmeteor-after="REORDER" type="javascript/blocked" data-src='{{asset('frontend/js/jquery-migrate.min.js')}}' id='jquery-migrate-js'></script>
      <script>
